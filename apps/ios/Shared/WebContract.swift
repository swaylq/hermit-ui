...
enum WebContract {
    ...
    static let emerald600 = Color(.displayP3, red: 0.2066, green: 0.5891, blue: 0.4140)
    /// `neutral-800` — oklch(26.9% 0 0)
    static let neutral800 = Color(.displayP3, red: 0.1494, green: 0.1494, blue: 0.1494)
    /// `neutral-900` — oklch(20.5% 0 0)
    static let neutral900 = Color(.displayP3, red: 0.0905, green: 0.0905, blue: 0.0905)
