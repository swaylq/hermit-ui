    ...
    <span data-slot="input-wrapper" className={cn("relative block w-full", wrapperClassName)}>
      ...
      {showClear && (
        <button
          ...
          onClick={clear}
          className="absolute right-1.5 top-1/2 -translate-y-1/2 inline-flex h-4 w-4 items-center justify-center rounded-sm text-muted-foreground/60 transition-colors hover:text-foreground cursor-pointer animate-in fade-in-0 zoom-in-95 duration-100"
        >
