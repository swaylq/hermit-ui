...
import {
  ...
  Trash2, RotateCw, FoldVertical, X, Store, Bell, ArrowLeft, Package, Search, Settings, Pin, NotebookText, Send, Folder, Moon, Eye, EyeOff, BookOpen, Drama, type LucideIcon,
} from 'lucide-react';
