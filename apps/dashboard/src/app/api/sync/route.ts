...
const CodexUsageInput = z.object({
  ...
  fiveHourPct: z.number().nullable().optional(),
  fiveHourResetsAt: z.string().nullable().optional(),
  fiveHourLimitId: z.string().max(128).nullable().optional(),
  fiveHourLimitName: z.string().max(128).nullable().optional(),
  weekPct: z.number().nullable().optional(),
  weekResetsAt: z.string().nullable().optional(),
  weekLimitId: z.string().max(128).nullable().optional(),
  weekLimitName: z.string().max(128).nullable().optional(),
